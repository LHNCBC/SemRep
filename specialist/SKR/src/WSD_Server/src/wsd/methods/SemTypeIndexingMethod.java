...
public class SemTypeIndexingMethod implements DisambiguationMethod
{
  ...
  static {
    ...
    logger.info("SemTypeIndexingMethod:class init: STI index initialized");
  }
  ...
  private List getCitation(Document doc)
  {
    List context = new ArrayList();
    Element root = doc.getRootElement();
    Namespace ns = root.getNamespace();
    List citationList = root.getChildren("citation", ns);
    ListIterator citationIterator = citationList.listIterator();
    while (citationIterator.hasNext())
      {
        Element citationNode = (Element)citationIterator.next();
        context.add(citationNode.getText());
      }
    if (logger.isDebugEnabled())
