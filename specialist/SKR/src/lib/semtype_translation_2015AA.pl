...
% File:     semtype_translation_2015AA.pl
% Module:   semtype_translation_2015AA
% Author:   Lan
...
UI and their TreeNo.  The data were derived from the 2008 Semantic Network.
...
semtype_translation('Amphibian','amph','T011','A1.1.3.1.1.1') :- !.
semtype_translation('Anatomical Abnormality','anab','T190','A1.2.2') :- !.
semtype_translation('Anatomical Structure','anst','T017','A1.2') :- !.
semtype_translation('Animal','anim','T008','A1.1.3.1') :- !.
semtype_translation('Antibiotic','antb','T195','A1.4.1.1.1.1') :- !.
semtype_translation('Archaeon','arch','T194','A1.1.1') :- !.
semtype_translation('Bacterium','bact','T007','A1.1.2') :- !.
...
semtype_translation('Bird','bird','T012','A1.1.3.1.1.2') :- !.
...
semtype_translation('Eukaryote','euka','T204','A1.1.3') :- !.
...
semtype_translation('Fish','fish','T013','A1.1.3.1.1.3') :- !.
...
semtype_translation('Fungus','fngs','T004','A1.1.3.2') :- !.
...
semtype_translation('Human','humn','T016','A1.1.3.1.1.4.1') :- !.
...
semtype_translation('Mammal','mamm','T015','A1.1.3.1.1.4') :- !.
...
semtype_translation('Plant','plnt','T002','A1.1.3.3') :- !.
...
semtype_translation('Reptile','rept','T014','A1.1.3.1.1.5') :- !.
...
semtype_translation('Vertebrate','vtbt','T010','A1.1.3.1.1') :- !.
semtype_translation('Virus','virs','T005','A1.1.4') :- !.
