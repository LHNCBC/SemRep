#define SP_IN_abgenemod_glue_c 1
...
char SP_FLI_CONST *));
SP_END_DECL
static SP_mutex sp_resource_mutex_abgenemod=SP_MUTEX_INITIALIZER;
#ifndef SPFUNCVARS
#define SPFUNCVARS 1
#include <stdio.h>
...
#endif
SP_BEGIN_DECL
extern SPGLUEEXP SP_MainFun sp_main_SPENV_abgenemod;
SP_END_DECL
static const char *abgenemod_prednames[] = {
"c_abgene",
0};
static int abgenemod_arities[] = {
2,
-1};
#if !SP_FLI_APPLY_ASM_GENERIC
static SP_GlueFun *abgenemod_funcs[] = {
(SP_GlueFun *)c_abgene,
0};
#endif /* !SP_FLI_APPLY_ASM_GENERIC */
#if SP_FLI_APPLY_ASM_GENERIC
static void SPCDECL glue_c_abgene(sp_t_fli_call *a)
{
   (void) a; /* Avoid unused argument warnings. */
a->integer_return = (SP_integer) /* [-string] */
c_abgene(
#if MULTI_SP_AWARE
...
static SP_GenericGlueFun *abgenemod_funcs[] = {
&glue_c_abgene,
0};
#endif /* SP_FLI_APPLY_ASM_GENERIC */
SPGLUEEXP1 int SPGLUEEXP2 SPCDECL sp_main_SPENV_abgenemod(SP_MAINFUN_PARAMS *params)
{
#if MULTI_SP_AWARE
   SPAPI_ARG_LOCAL_DECL
#endif
   return sp_main_helper(params, 0x30001, GetSICStusDISPATCHAddress(), &sp_resource_mutex_abgenemod, abgenemod_funcs, abgenemod_prednames, abgenemod_arities, NULL, NULL);
}
