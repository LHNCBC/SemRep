...
empty_head_base_1_DOM(able). % Public Health
empty_head_base_1_DOM(aid).
empty_head_base_1_DOM(aiding).
...
%empty_head_base_1_DOM(receptor-).
empty_head_base_1_DOM(receptiveness).
...
concept_to_ignore_1(art,'Products of the Arts'). % PH
concept_to_ignore_1(able,'Able'). % June 2011 Public health
...
concept_to_ignore_1(address,'Address'). % Public Health June 2011
concept_to_ignore_1(addressing,'Address'). % Public Health June 2011
concept_to_ignore_1(aiding,'Acquired Immunodeficiency Syndrome'). % Graciela 
...
concept_to_ignore_1(analysing,'Analyzed'). % Public Health
...
% Error: Preferred name: Anti - Inflammatory Agents is not in UMLS 2006AA
...
concept_to_ignore_1(branded,3-bromoacetoxyandrostan-17-one). % GR synonym is BrAnd
% Error: Preferred name: Does budget is not in UMLS 2006AA
%concept_to_ignore_1(budgets,'Does budget').

 % GR
% Error: Preferred name: Does budget (finding) is not in UMLS 2006AA
%concept_to_ignore_1(budgets,'Does budget (finding)').
...
concept_to_ignore_1(content,'Role Class - content'). % Public Health
...
concept_to_ignore_1(counseling,'Counsel - legal'). % Public Health
concept_to_ignore_1(cover,'Covers'). % GR DIM
concept_to_ignore_1(creation,'Surgical construction'). % GR
concept_to_ignore_1('cross - sectional','CROSS SECTION'). % Public Health
...
% Error: Preferred name: DON is not in UMLS 2006AA
%concept_to_ignore_1(donning,'DON').

 % GR 09/09
concept_to_ignore_1(drph,'melanophore-dispersing hormone'). % GR DIM 09/09
concept_to_ignore_1('drug use','Encounter due to drug use'). % Public health
...
concept_to_ignore_1(effective,'Effect'). % Public Health
concept_to_ignore_1(effort,'Exertion'). % GR
concept_to_ignore_1(emergency,'Bale out'). % GR
concept_to_ignore_1(employ,'Employed'). % Public Health
concept_to_ignore_1(employs,'Employed'). % Public Health
concept_to_ignore_1(employed,'Employed'). % Public Health
...
concept_to_ignore_1(evaluation,'Assessment procedure'). % Public Health
...
% Error: Preferred name: Expectancy is not in UMLS 2006AA
%concept_to_ignore_1(expectation,'Expectancy').


% Error: Preferred name: expectation (psychology) is not in UMLS 2006AA
%concept_to_ignore_1(expectation,'expectation (psychology)').


% Error: Preferred name: Expectation context is not in UMLS 2006AA
%concept_to_ignore_1(expectation,'Expectation context').


% Error: Preferred name: Expectation context (qualifier value) is not in UMLS 2006AA
%concept_to_ignore_1(expectation,'Expectation context (qualifier value)').


% Error: Preferred name: Expectations (qualifier value) is not in UMLS 2006AA
...
concept_to_ignore_1(fumar,'Ferrous fumarate'). % Public Health
...
concept_to_ignore_1(higher,'High'). % GR Public Health
...
concept_to_ignore_1(introduction,'Introduction procedure'). % Public Health
concept_to_ignore_1('INTRODUCTION','Introduction procedure'). % Public Health
...
concept_to_ignore_1(likely,'Probable diagnosis'). % Graciela
...
% Error: Preferred name: Little is not in UMLS 2006AA
%concept_to_ignore_1(little,'Little').

 % GR
% Error: Preferred name: Little Disease is not in UMLS 2006AA
%concept_to_ignore_1(little,'Little Disease').
...
concept_to_ignore_1(moves,'Does move'). % PH project
...
concept_to_ignore_1(pilot,'Pilot'). % Public Health
...
concept_to_ignore_1('preventive services','Preventive Services - Orthodontics'). % Public Health	
concept_to_ignore_1('preventive service','Preventive Services - Orthodontics'). % Public Health
...
concept_to_ignore_1('quality study','Qualitative Research'). % Public Health
concept_to_ignore_1(quit,'QUIT'). % June 2011 Public Health
...
concept_to_ignore_1(reduce,'Reduced'). % Public Health
concept_to_ignore_1(reduced,'Reduced'). % Public Health
concept_to_ignore_1(reduces,'Reduced'). % Public Health
concept_to_ignore_1(reducing,'Reduced'). % Public Health
...
% Error: Preferred name: Resident - Procedure Practitioner Identifier Code Type is not in UMLS 2006AA
%concept_to_ignore_1(resident,'Resident - Procedure Practitioner Identifier Code Type').

 % GR DIM Project
concept_to_ignore_1(respirator,'Ventilators, Mechanical'). % GR DIM
concept_to_ignore_1(responsible,'Responsible to').
concept_to_ignore_1(rheumatology,'Rheumatologist'). % Public Health
...
concept_to_ignore_1(sensitivity,'Antimicrobial susceptibility'). % Public Health
...
concept_to_ignore_1('smoking cessation intervention','Smoking cessation assistance'). % Public Health
...
concept_to_ignore_1(sell,'Sells'). % Public health
concept_to_ignore_1(sells,'Sells'). % Public health
concept_to_ignore_1(sold,'Sells'). % Public health
...
concept_to_ignore_1(telephone,'Consent Mode - Telephone'). % Public Health
concept_to_ignore_1(telephone,'Participation Mode - telephone'). % Public Health
concept_to_ignore_1(telephone,'URL Scheme - Telephone'). % Public Health
...
concept_to_ignore_1(therapy,'therapeutic aspects'). % GR DIM
...
% Error: Preferred name: TIPSS is not in UMLS 2006AA
%concept_to_ignore_1(tips,'TIPSS').

 % GR
concept_to_ignore_1(tips,'Transjugular intrahepatic portosystemic shunt procedure'). % GR
concept_to_ignore_1('tobacco use','Encounter due to tobacco use'). % Public Health
...
concept_to_ignore_2N(_Base1,_Base2,_MetaConc).
...
%ignore_type_relation_type_1_DOM(% Author:   FML/CA/GR,% Purpose:  database of empty-head terms and MT concepts to ignore compiled by GR,% ----- Module declaration and exported predicates). % ----- Source Code Control System
...
ignore_type_relation_type_1_DOM(comd,process_of,amim). % GR 09/14/09
...
ignore_type_relation_type_1_DOM(dora,treats,dsyn).
ignore_type_relation_type_1_DOM(dora,treats,humn).
ignore_type_relation_type_1_DOM(dora,treats,popg).
ignore_type_relation_type_1_DOM(dsyn,treated_by,dora).
ignore_type_relation_type_1_DOM(humn,treated_by,dora).
ignore_type_relation_type_1_DOM(popg,treated_by,dora).
